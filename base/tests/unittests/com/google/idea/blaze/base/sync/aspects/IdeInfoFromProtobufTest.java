...
/** Tests for {@link IdeInfoFromProtobuf}. */
@RunWith(JUnit4.class)
public class IdeInfoFromProtobufTest {
   ...
   */
  @Test
  public void resourceBackwardsCompatibilityTest() throws Exception {
    ...
    AndroidIdeInfo output = IdeInfoFromProtobuf.makeAndroidIdeInfo(input);

    assertThat(
            output.getResources().stream()
                .map((it) -> it.getRelativePath())
   ...
   */
  @Test
  public void resourceFolderAndResourcesTest() throws Exception {
    ...
    assertThat(folder0.getRoot()).isEqualTo(IdeInfoFromProtobuf.makeArtifactLocation(myLibRoot));
    assertThat(folder1.getRoot())
        .isEqualTo(IdeInfoFromProtobuf.makeArtifactLocation(anotherLibRoot));
   ...
   */
  @Test
  public void resourceFolderWithoutResourcesTest() throws Exception {
    Common.ArtifactLocation myLibRoot = sourceProto("com/google/mylib/res");
    Common.ArtifactLocation anotherLibRoot = sourceProto("com/google/anotherlib/res");
